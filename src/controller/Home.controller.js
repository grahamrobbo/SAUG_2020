sap.ui.define(
	...
	function (Controller, JSONModel) {
		return Controller.extend("yelcho.SAUG2020.controller.Home", {
			onInit: function () {
				// HTML string bound to the formatted text control
				const oModel = new JSONModel({
					HTML:
						"<p>We are now in the Home View of the Root component. By clicking on the other three items (Suppliers, Categories and Products) in the left menu, further components will be loaded and nested into the Root component.</p>" +
